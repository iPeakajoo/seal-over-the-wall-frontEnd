...
const CheckoutShipping = () => {
  ...
  return (
  <>
  <p className='font-thin'>TESTESTESTSET</p>
    <div className="flex flex-col w-[1072px] mx-auto mb-10">
        <div className='mb-[40px]'>
            <h1 class="mt-[40px] text-[2rem] font-semibold col-span-2">Shipping Address</h1>
            ...
            <form className='mb-[56px]'>
              ...
              <label className="flex text-xl justify-between items-center w-full mb-[20px] border-b-[1.25px] pb-4 border-secondary-light-gray-500 cursor-pointer">
                <div className='flex flex-col w-[705px]'>
                  ...
                  <span class="font-[500] text-xl w-[120px] text-center">{`60`} THB</span>
              </label>
