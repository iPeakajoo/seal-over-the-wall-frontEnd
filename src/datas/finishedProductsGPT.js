export const products = [
    ...
    { productId: 4,
      productType: "shirt",
      styleName: "dont",
      title: "Don't Kill My Vibe T-Shirt",
      description: "Protect your peace with every step.",
      basePrice: 499,
      createdAt: new Date(),
      size: ["s", "m", "l"],
      color: [{
...

    {
      ...
      description: "Protect your peace with every sip.",
      basePrice: 499,
      createdAt: new Date(),
      size: ["one-size"],
      color: [{
...

    {
      ...
      description: "Not your average command.",
      basePrice: 499,
      createdAt: new Date(),
      size: ["s", "m", "l"],
      color: [{
    ...
    },
    {
      ...
      productType: "shirt",
      styleName: "espresso",
      title: "More Espresso Less Depresso T-Shirt",
      description: "Fuel your day with less drama.",
      basePrice: 499,
      createdAt: new Date(),
      size: ["s", "m", "l"],
      color: [{
    ...
    productType: "bag",
    styleName: "espresso",
    title: "More Espresso Less Depresso Bag",
    description: "Fuel your day with less drama.",
    basePrice: 499,
    createdAt: new Date(),
    size: ["one-size"],
  ...
  },
  {
    ...
    productType: "cup",
    styleName: "espresso",
    title: "More Espresso Less Depresso Cup",
    description: "Fuel your day with less drama.",
    basePrice: 499,
    createdAt: new Date(),
    size: ["one-size"],
  ...
  },
  {
    ...
    productType: "shirt",
    styleName: "think",
    title: "Think Outside the Box T-Shirt",
    description: "Innovate, disrupt, repeat.",
    basePrice: 499,
    createdAt: new Date(),
    size: ["s", "m", "l"],
    color: [
  ...
  },
  {
    ...
    productType: "shirt",
    styleName: "screaming",
    title: "Screaming Internally T-Shirt",
    description: "Keep it cool outside. Chaos inside.",
    basePrice: 499,
    createdAt: new Date(),
    size: ["s", "m", "l"],
    color: [{
  ...
  },
  {
    ...
    productType: "bag",
    styleName: "screaming",
    title: "Screaming Internally Bag",
    description: "Keep it cool outside. Chaos inside.",
    basePrice: 499,
    createdAt: new Date(),
    size: ["one-size"],
...

  {
    ...
    productType: "cup",
    styleName: "screaming",
    title: "Screaming Internally Cup",
    description: "Keep it cool outside. Chaos inside.",
    basePrice: 499,
    createdAt: new Date(),
    size: ["one-size"],
...

  {
    ...
    productType: "shirt",
    styleName: "own",
    title: "Own Your Lane T-Shirt",
    description: "Stay focused, stay true.",
    basePrice: 499,
    createdAt: new Date(),
    size: ["s", "m", "l"],
    color: [{
...

  {
    ...
    productType: "shirt",
    styleName: "just",
    title: "Just Keep Running T-Shirt",
    description: "Pace yourself. The grind is long.",
    basePrice: 499,
    createdAt: new Date(),
    size: ["s", "m", "l"],
    color: [{
...

  {
    ...
    productType: "shirt",
    styleName: "custom",
    title: "Custom Mike Bag",
    description: "Let your bag say it all, your way.",
    basePrice: 499,
    createdAt: new Date(),
    size: ["s", "m", "l"],
    color: [{
...

  {
    ...
    productType: "cup",
    styleName: "custom",
    title: "Custom Mike Cup",
    description: "Let your cup say it all, your way.",
    basePrice: 499,
    createdAt: new Date(),
    size: ["one-size"],
    color: [{
